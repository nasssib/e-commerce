                                    ...
                                    @foreach (Cart::content() as $p)
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-remove">
                                                <a href="{{ route('cart.delete', ['id'=>$p->rowId]) }}" class="product-del remove" title="Remove this item">
                                            ...
                                            <td class="product-thumbnail">
                                                ...
                                                <div class="cart-product__item">
                                                    <a href="#">
                                                        <img src=" {{ asset($p->model->image) }}" alt="product"
                                            ...
                                            <td class="product-price">
                                                <h5 class="price amount">{{ $p->price }}</h5>
                                            </td>

                                            <td class="product-quantity">

                                                <div class="quantity">
                                                    <a href="{{ route('cart.decr', ['id'=>$p->rowId , 'qty'=>$p->qty,]) }}" class="quantity-minus quantity-minus-n">-</a>
                                                    <input title="Qty" value="{{ $p->qty }}"
                                                        class="email input-text qty text" type="text" placeholder="1"
                                                        readonly>
                                                    <a href="{{ route('cart.incr', ['id'=>$p->rowId , 'qty'=>$p->qty,]) }}" class="quantity-plus quantity-plus-n">+</a>
                                                </div>

                                            </td>

                                            <td class="product-subtotal">
                                                <h5 class="total amount">{{ $p->total() }}</h5>
                                            </td>
